...
public class FastByteOperations {
    ...
    public static int compareWithMemoryUnsigned(
        ByteBuffer b1,
        long address2,
        int length2
    ) {
    ...
    private static class BestHolder {
        ...
        static ByteOperations getBest() {
            ...
            try {
                ...
                ByteOperations comparer = (ByteOperations) theClass
                    .getConstructor()
                    .newInstance();
                return comparer;
            } catch (Throwable t) {
    ...
    //         try {
    //             // BYTE_ARRAY_BASE_OFFSET = theUnsafe.arrayBaseOffset(
    //             //     byte[].class
    //             // );
    //             // DIRECT_BUFFER_ADDRESS_OFFSET = theUnsafe.objectFieldOffset(
    ...
    //     static final boolean BIG_ENDIAN = ByteOrder.nativeOrder()
    ...
    //             obj1 = buffer1.array();
    //             offset1 =
    //                 BYTE_ARRAY_BASE_OFFSET + buffer1.arrayOffset() + position1;
    //         } else {
    //             obj1 = null;
    //             offset1 =
    //                 theUnsafe.getLong(buffer1, DIRECT_BUFFER_ADDRESS_OFFSET) +
    //                 position1;
    //         }
    ...
    //         int length
    //     ) {
    //         if (src.hasArray()) System.arraycopy(
    //             src.array(),
    ...
    //             null,
    //             srcPosition +
    //             theUnsafe.getLong(src, DIRECT_BUFFER_ADDRESS_OFFSET),
    //             trg,
    //             trgPosition,
    //             length
    //         );
    ...
    //         int length
    //     ) {
    //         if (trg.hasArray()) System.arraycopy(
    //             src,
    //             srcPosition,
    //             trg.array(),
    ...
    //         else copy(
    //             (Object) src,
    //             (long) srcPosition + Unsafe.ARRAY_BYTE_BASE_OFFSET,
    //             trg,
    //             trgPosition,
    //             length
    //         );
    ...
    //         int length
    //     ) {
    //         if (trgBuf.hasArray()) copy(
    //             src,
    //             srcOffset,
    //             trgBuf.array(),
    //             trgBuf.arrayOffset() + trgPosition,
    //             length
    //         );
    //         else copy(
    //             src,
    ...
    //             null,
    //             trgPosition +
    //             theUnsafe.getLong(trgBuf, DIRECT_BUFFER_ADDRESS_OFFSET),
    //             length
    //         );
    //     }
    ...
    //             for (int i = 0; i < length; i++) trg[trgPosition + i] =
    //                 theUnsafe.getByte(src, srcOffset + i);
    //         } else {
    //             copy(
    //                 src,
    //                 srcOffset,
    //                 trg,
    //                 BYTE_ARRAY_BASE_OFFSET + trgPosition,
    //                 length
    //             );
    //         }
    //     }
    ...
    //                     Long.reverseBytes(lw),
    //                     Long.reverseBytes(rw)
    //                 );
    //             }
    //         }
    ...
    //         if (
    //             buffer1 == buffer2 && offset1 == offset2 && length1 == length2
    //         ) return 0;
    ...
    //         int length2
    //     ) {
    //         if (buffer1.hasArray()) return compare(
    //             buffer1.array(),
    //             buffer1.arrayOffset() + position1,
    //             length1,
    //             buffer2,
    //             offset2,
    //             length2
    ...
    //             "native memory address is an argument, we cannot do it using a pure Java"
    //         );
    //     }
    ...
    //         for (
    //             int i = buffer1.position(), j = buffer2.position();
    //             i < end1 && j < end2;
    //             i++, j++
    //         ) {
